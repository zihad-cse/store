    ...
    <div class="product-container">
        <div class="product-img-wrapper">
                <div class="product-img-container">
                    <img class="product-img" src="https://daccastore.erp.place/erp/companies/daccastore/part_pics/1.jpeg" onclick="openImage(this.src)" alt="Product Image">
                </div>
        ...
        <div class="m-4 product-desc-wrapper">
            ...
            <div class="product-desc-category">
                <a class="text-decoration-none" href="">Category</a>
            </div>
            ...
            <div class="mx-1 product-desc-cart">
                <div>
                    ...
                    <input id="cartQty" class="product-desc-cart-qnty" type="number" value="1" min="1">
